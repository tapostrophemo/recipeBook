...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr>
  <td width="33%"><?=$this->load->view('book/category', array('name' => 'Main Dishes', 'code' => Recipe::MAIN_DISH, 'recipes' => $recipes))?></td>
 ...
 <tr>
  ...
  <td><?=$this->load->view('book/category', array('name' => 'Breads', 'code' => Recipe::BREAD, 'recipes' => $recipes))?></td>
 </tr>
</table>
